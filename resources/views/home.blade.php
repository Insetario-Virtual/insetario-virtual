...
<div class="pb-4 w-full h-fit px-10 max-sm:px-4 bg-fixed bg-no-repeat bg-cover bg-center">
    ...
    <h1 class="pt-4 text-3xl font-bold text-white mb-6 md:text-4xl">Informações do Projeto</h1>

    <div class="w-full h-fit rounded py-3 z-10">

        @foreach ($siteContent as $content)
        <section class="mb-8">
            <h2 class="mt-5 text-xl font-semibold text-white md:text-2xl">{{ $content->title }}</h2>
